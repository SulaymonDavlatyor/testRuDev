...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] HEADERS = {"productId", "sellerId", "oriMinPrice", "oriMaxPrice", "productTitle", "promotionId"};
        ...
        try (CSVPrinter printer = new CSVPrinter(out, CSVFormat.DEFAULT
            ...
            products.forEach(product -> {
                ...
                try {
                    printer.printRecord(product.getProductId(), product.getSellerId(), product.getOriMinPrice(), product.getOriMaxPrice(), product.getProductTitle(), product.getPromotionId());
                } catch (IOException e) {
                    e.printStackTrace();
                }
            });
